                ...
                <ul class="image-main-box clearfix">
                    ...
                    <li class="item col-xs-6 col-md-4 pool">
                        <figure>
                            ...
                            <a href="/img/gallery/24.jpg" class="more-details" data-title="{{ trans('lang.description_img_index_19') }}">Enlarge</a>
                            <figcaption>
                    ...
                    <li class="item col-xs-6 col-md-4 pool">
                        <figure>
                            ...
                            <a href="/img/gallery/25.jpg" class="more-details" data-title="{{ trans('lang.description_img_index_20') }}">Enlarge</a>
                            <figcaption>
                    ...
                    <li class="item col-xs-6 col-md-4 pool">
                        <figure>
                            ...
                            <a href="/img/gallery/26.jpg" class="more-details" data-title="{{ trans('lang.description_img_index_21') }}">Enlarge</a>
                            <figcaption>
                    ...
                    <li class="item col-xs-6 col-md-4 pool">
                        <figure>
                            ...
                            <a href="/img/gallery/19.jpg" class="more-details" data-title="{{ trans('lang.description_img_index_22') }}">Enlarge</a>
                            <figcaption>
                    ...
                    <li class="item col-xs-6 col-md-4 rooms">
                        <figure>
                            ...
                            <a href="/img/gallery/20.jpg" class="more-details" data-title="{{ trans('lang.description_img_index_23') }}">Enlarge</a>
                            <figcaption>
                    ...
                    <li class="item col-xs-6 col-md-4 pool">
                        <figure>
                            ...
                            <a href="/img/gallery/21.jpg" class="more-details" data-title="{{ trans('lang.description_img_index_24') }}">Enlarge</a>
                            <figcaption>
